/*
  # Prefix-first storage ingestion with safe legacy fallback

  Goal:
  - Keep park-slug prefix routing as primary mode
  - Restore ingestion for legacy uploads without prefix during migration phase
  - Avoid unsafe cross-park assignments in ambiguous cases
*/
